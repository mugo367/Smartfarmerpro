...
public class CustomerDetailActivity extends AppCompatActivity {
    ...
    private String name, maize, producedon, detail, qty,price,image,poster,time,postId,category, adddetail;
    private TextView tvDetailTitle,tvDetailViews,tvDetailLikes,tvDetailQty,tvDetaildetail, tvDetailadd, tvDetailmaizetype, tvDetaildate, tvDetailCategory,tvDetailPoster,tvDetailPrice,tvDetailTime,tvPosterPhone,tvPosterCounty,tvPosterSubcounty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDetailadd = findViewById(R.id.tvDetailadddetail);
            ...
            public void onClick(View v) {
                myProductsDatabase.child(postId).child("product_likes").child(userId).setValue("1").addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(CustomerDetailActivity.this, "You Liked this product...", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
