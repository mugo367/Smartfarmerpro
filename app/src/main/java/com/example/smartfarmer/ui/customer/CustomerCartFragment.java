...
import com.example.smartfarmer.ui.market.Cart;
...
public class CustomerCartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cartList=view.findViewById(R.id.cartListcus);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CustomerCartFragment.CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CustomerCartFragment.CartViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final CustomerCartFragment.CartViewHolder holder, final int position, @NonNull Cart model) {
            ...
            @NonNull
            @Override
            public CustomerCartFragment.CartViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view=LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.single_cart,viewGroup,false);
                CustomerCartFragment.CartViewHolder viewHolder=new CustomerCartFragment.CartViewHolder(view);
